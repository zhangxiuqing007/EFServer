...
func (data *CmtAddData) buildCmtDbIns() *forum.CommentInDB {
...
func QueryCommentsOfPostPage(postID int, count, offset int, userID int) ([]*forum.CmtOnPostPage, error) {
...
//QueryComment 查询评论
func QueryComment(cmtID int) (*forum.CommentInDB, error) {
	return db.QueryComment(cmtID)
}

//UpdateComment 更新帖子
func UpdateComment(cmt *forum.CommentInDB) error {
