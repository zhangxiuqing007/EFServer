...
func Test_HelpAddStandardThemes(t *testing.T) {
	iotool := new(testResourceBuilder).buildCurrentTestSQLIns()
	defer iotool.Close()
	iotool.AddTheme(&forum.ThemeInDB{ID: 0, Name: "要闻", PostCount: 0})
	iotool.AddTheme(&forum.ThemeInDB{ID: 0, Name: "国内", PostCount: 0})
	iotool.AddTheme(&forum.ThemeInDB{ID: 0, Name: "国际", PostCount: 0})
	iotool.AddTheme(&forum.ThemeInDB{ID: 0, Name: "社会", PostCount: 0})
	iotool.AddTheme(&forum.ThemeInDB{ID: 0, Name: "军事", PostCount: 0})
	iotool.AddTheme(&forum.ThemeInDB{ID: 0, Name: "娱乐", PostCount: 0})
	iotool.AddTheme(&forum.ThemeInDB{ID: 0, Name: "体育", PostCount: 0})
	iotool.AddTheme(&forum.ThemeInDB{ID: 0, Name: "汽车", PostCount: 0})
	iotool.AddTheme(&forum.ThemeInDB{ID: 0, Name: "科技", PostCount: 0})
}
...
func Test_HelpAddSomePostAndCmts(t *testing.T) {
	...
	allCmts := make([]*forum.CommentInDB, 0, cmtMaxCount+postMaxCount*2)
	cmts = cmts[0:0]
	//多轮评论
