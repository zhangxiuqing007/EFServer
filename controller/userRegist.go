...
var userRegistInputTemplate = template.Must(template.ParseFiles("view/registInput.html"))
var userRegistSuccessTemplate = template.Must(template.ParseFiles("view/registSuccess.html"))
